// TODO: uncomment and refactor while doing map page
...
// export function CalendarSingleTimeTable({
//   rooms,
//   roomsToColors,
//   startTime,
//   endTime,
...
//       <div className="grid-col-4 grid w-full grid-rows-1">
//         <div className="border-r-4 border-black p-2">
//           <div className="border-b-4 border-black pb-8 text-center">Time</div>
//           <div className="pt-4">
...
//           </div>
//         </div>
//         <div className="col-start-2 col-end-5 p-2">
//           <div className="border-b-4 border-black pb-8 text-center">
//             Reservations
//           </div>
//           <div className="pt-4">
...
//                 className={twMerge(
//                   "h-3 cursor-pointer border-t-2 border-dotted border-primary text-center",
//                   i % 4 === 0 && "border-solid",
//                   reservation.colors,
